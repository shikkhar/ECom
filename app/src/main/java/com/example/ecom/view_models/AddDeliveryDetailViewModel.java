...
public class AddDeliveryDetailViewModel extends ViewModel {
    ...
    public void addDeliveryDetail(DeliveryDetail deliveryDetails){
        repository.addDeliveryDetail(new DeliveryDetailOperationCallback(isOperationSuccessfulLiveD), deliveryDetails);
    }
